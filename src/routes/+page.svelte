...
<div class="navbar bg-base-100 pb-3">
	<div class="navbar-start"></div>
	<div class="btn btn-ghost navbar-center">
		<svg
		...
		<a href="/" class="text-3xl">FamCoTree</a>
	</div>
	<div class="navbar-end"></div>
</div>

<div class="mb-10 grow content-center items-center text-center md:mb-0">
	<article class="prose mx-auto items-center self-center">
		<h1 class=" text-3xl">Welcome to FamCoTree!</h1>
		<p>
			With FamCoTree you can create a cross-compatible single-file interconected family tree and use
